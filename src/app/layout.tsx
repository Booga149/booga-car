  ...
  return (
    <html lang="ar" dir="rtl" suppressHydrationWarning>
      <head>
        ...
        <link rel="dns-prefetch" href="https://zjzzivxrqvpsnyoqqszt.supabase.co" />
        <link rel="dns-prefetch" href="https://images.unsplash.com" />
        <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@400;500;600;700;800;900&display=optional" rel="stylesheet" />
            ...
            <WishlistProvider>
              <ProductsProvider>
                <CartProvider>
                  ...
                  {/* Marketing & Tracking Systems Init */}
                  <Script id="marketing-init" strategy="afterInteractive">
                    {`
                      window.dataLayer = window.dataLayer || [];
                      ${process.env.NEXT_PUBLIC_GA_ID ? '' : 'console.log("📊 [Analytics] لتفعيل Google Analytics، أضف NEXT_PUBLIC_GA_ID في .env.local");'}
                    `}
                  </Script>
